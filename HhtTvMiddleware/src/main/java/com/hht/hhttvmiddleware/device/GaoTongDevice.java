...
public class GaoTongDevice extends HHTDevice {
    ...
    public boolean isEyemodeEnable(Context context) {
        show(context,eyeModeEnable,"gaotong 护眼模式");
    ...
    public boolean isWbWriteProtectEnable(Context context) {
        show(context,wbWriteProtectEnable,"gaotong 护眼书写");
    ...
    public boolean isBlightControlEnable(Context context) {
        show(context,blightControlEnable,"gaotong 护眼光控");
